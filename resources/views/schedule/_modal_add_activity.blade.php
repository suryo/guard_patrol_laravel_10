    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <form id="formAddActivity" class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="maa-schedule-group-uid" name="schedule_group_uid">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="maa-note" class="form-control" rows="2"
                            placeholder="Catatan untuk semua activity yang ditambahkan (opsional)"></textarea>
                    </div>
                </div>
            </div>
